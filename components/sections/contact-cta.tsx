...
export function ContactCta({ locale }: ContactCtaProps) {
  const copy = {
    tr: {
      title: "AI, otomasyon, web — hangisi işletmenize en hızlı geri döner?",
      text: "15 dakikalık ücretsiz keşif görüşmesinde ihtiyacınızı netleştirelim: AI agent, WhatsApp / süreç otomasyonu, özel yazılım veya hazır web sitesi — sizin için en doğru teslim planını çıkaralım. 24 saat içinde geri dönüş.",
    ...
    en: {
      ...
      text: "In a focused 15-minute discovery call we map the right delivery plan: AI agent, WhatsApp / workflow automation, custom software or a fast-launch website. Reply within 24 hours.",
